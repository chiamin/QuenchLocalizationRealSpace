...
MYFLAGS=-I$(MYDIR) -Iitdvp -Idmrg -Itdvp -fmax-errors=3 -Wno-unused-function -Wno-sign-compare

HEADERS=itdvp/GenMPO.h itdvp/uGauge.h itdvp/FixedPointTensor.h itdvp/Solver.h itdvp/GlobalIndices.h itdvp/iTDVP.h
